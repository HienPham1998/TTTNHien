...
<div class="container">
    <div class="col-sm-12" style="padding-top:80px" id="content">
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center"><a href="#"><img class="img-thumbnail" style="width:100px"
                            ...
                            <td class="text-right">
                                ...
                                &nbsp; &nbsp; &nbsp;{{$product->options->promotion_price}} vnd
                            </td>
                            @else
                            <td class="text-right">
                                &nbsp; &nbsp; &nbsp;{{$product->price}} vnd
                            ...
                            @endif
                            <td class="text-right">
                              {{$product->options->promotion_price}}   vnd </td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
        ...
        <div id="accordion" class="panel-group">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title"><a class="accordion-toggle " aria-expanded="true" data-parent="#accordion"
                            data-toggle="collapse" href="#collapse-coupon">Use Coupon Code <i
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse"
                            class="accordion-toggle collapsed" href="#collapse-shipping">Estimate Shipping &amp; Taxes
        ...
        <div class="buttons">
            ...
            <div class="pull-right"><a class="btn btn-primary" href="/order">Check out</a></div>
        </div>
    </div>
</div>
@endsection
